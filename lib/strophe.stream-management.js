...
strophe_js.Strophe.addConnectionPlugin('streamManagement', {
	...
	*/
	...
	enable: function() {
		this._c.send(strophe_js.$build('enable', {xmlns: this._NS, resume: false}));
		this._c.flush();
		this._c.pause();
	},
	...
	statusChanged: function (status) {
		if (status === strophe_js.Strophe.Status.CONNECTED || status === strophe_js.Strophe.Status.DISCONNECTED) {
	...
	*/
	...
	_incomingStanzaHandler: function(elem) {
		if (strophe_js.Strophe.isTagEqual(elem, 'enabled') && elem.getAttribute('xmlns') === this._NS) {
		...
		if (strophe_js.Strophe.isTagEqual(elem, 'a')) {
